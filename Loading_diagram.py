...
plt.plot([x_empty, x_forward],[W_empty, W_empty+W_forward], '-o', color = 'deeppink')
plt.plot([x_empty, x_aft],[W_empty, W_empty+W_aft], '-o', color = 'deeppink')
plt.plot([x_forward, x_both], [W_empty+W_forward, W_empty+W_both], '-o' , color = 'deeppink')
plt.plot([x_aft, x_both], [W_empty+W_aft, W_empty+W_both], '-o', color = 'deeppink')
plt.show()